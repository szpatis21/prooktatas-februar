...
var pizzak = [{
  ...
  adatok: function adatok() {
    return "Ez a pizza egy: " + this.név + " pizza , mérete: " + this.méret + "cm " + this.szószalap + "alapszósszal, és a következő feltéteket tartalmazza: " + this.feltétek + ".";
  },
  adatok2: function adatok2() {
    return "<h1>" + this.név;
  }
}, {
  név: "Hawaii extra",
  ...
  adatok: function adatok() {
    return "Ez a pizza egy: " + this.név + " pizza , mérete: " + this.méret + "cm " + this.szószalap + " szósszal, és a következő feltéteket tartalmazza: " + this.feltétek + ".";
  },
  adatok2: function adatok2() {
    return "<h1>" + this.név;
  }
